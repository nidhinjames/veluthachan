...
public class jan14 extends Activity{
	...
	public void onCreate(Bundle savedInstanceState) {
     ...
     // item2 event
      ...
      //item5 event
        ...
        //day
    	day_name.setText("ഭക്തസംഘടനാ ദിനം  ");
    	...
    	//item3 event
    	it3_time.setText("10.30 AM");
    	it3_event.setText("നൊവേന\nലിറ്റനി\nസമൂഹബലി");
    	it3_event.setTypeface(typeFace);

    	//item4 event
    	it4_time.setText("4.30 PM");
		it4_event.setText("ജപമാല\nനൊവേന\nലിറ്റനി\nസായാപ്ന്ന പ്രാർത്ഥന");
    	it4_event.setTypeface(typeFace);

    	//item4 event
    	it5_time.setText("5.45 PM");
